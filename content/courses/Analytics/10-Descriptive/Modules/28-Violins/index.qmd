---
title: <iconify-icon icon="material-symbols:light-group-rounded" width="1.2em" height="1.2em"></iconify-icon> Groups and Distributions
subtitle: ""
date: 15/Nov/2022
...
#     wrap: 72
webr:
  packages: ['readr', 'tidyr', 'dplyr','mosaic', 'skimr','forcats', 'ggformula','ggridges', 'palmerpenguins', 'janitor']
format: 
  html: default
  revealjs: 
    theme: default
...
```{r}
#| label: fig-inspiration-violin-plot
#| fig-cap: Violin Plot Inspirations
#| warning: false
#| message: false
#| echo: false
...
gf_violin(price ~ "All Diamonds", data = diamonds_modified, 
...
gf_violin(price ~ "", data = diamonds_modified, 
          draw_quantiles = c(0,.25,.50,.75)) %>%
  gf_labs(title = "Plot A: Violin plot for Diamond Prices")
...
gf_violin(price ~ cut, data = diamonds_modified,
            draw_quantiles = c(0,.25,.50,.75)) %>% 
  gf_labs(title = "Plot B: Price by Cut")
...
:::callout-note
### From [Groups](../24-Groups/index.qmd#your-turn)
3.  Datasets from the earlier module on [Groups](../24-Groups/index.qmd#your-turn).
:::
...
What story can you tell, and deduction can you make from @fig-ai-detectors-are-biased below? What would you add?

![AI Detectors](../../../../../materials/images/ai-bias.png){#fig-ai-detectors-are-biased height="360px"}
