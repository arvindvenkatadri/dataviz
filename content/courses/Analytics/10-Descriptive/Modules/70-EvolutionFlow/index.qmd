...
Note also that the [Bump Charts](/content/courses/Analytics/10-Descriptive/Modules/80-Ranking/index.qmd#bump-charts) are a special case of Alluvial/Sankey charts where each node connects/flows to **only** one other node.
