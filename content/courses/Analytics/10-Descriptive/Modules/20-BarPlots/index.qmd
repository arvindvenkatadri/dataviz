...
- (Future) The counts of `tip` are very imbalanced and if we are to setup a model for that ([logistic regression](../../../30-Modelling/Modules/LogReg/index.qmd)) we would need to  very carefully subset the data for `training` and `testing` our model. 
