...
wages_clean %>% 
  ...
  gf_labs(title = "Plot 1A: Income has a skewed distribution",
          ...
          x = "") #Blank out the X-axis title
```
:::
::: {.column}
```{r}
#| ref-label: realincome-ggformula
#| label: fig-realincome-ggformula
#| fig-cap: "Basic Distribution of Income"
#| echo: false
```
...
#| echo: false
#| fig-cap: "Split by Education Category"
```
...
#| echo: false
#| fig-cap: "Split by Education Category and Family Size"
```
:::
::::
...
#| fig-cap: "Split by Gender and Family Size"
```
:::
::::
