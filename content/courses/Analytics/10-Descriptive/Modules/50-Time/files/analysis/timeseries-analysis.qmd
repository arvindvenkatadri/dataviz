...
# library(lubridate)  # Deals with dates, loads with the tidyverse
library(mosaic) # Our go-to package for everything
...
Very cool to know that `dplyr::glimpse()` identifies `date` variables
separately!
