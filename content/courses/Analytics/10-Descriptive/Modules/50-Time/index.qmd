...
|                                                                                                             |                                                                                                              |
|------------------------------------|------------------------------------|
| <a href="./files/wrangling/timeseries-wrangling.qmd"><i class="fa-brands fa-r-project"></i>TimeSeries Wrangling</a>   | <a href="./files/analysis/timeseries-analysis.qmd"> <i class="fa-solid fa-person-rays"></i> Time Series Analysis-WIP</a>  |
...
![Time Series Data Standards](https://imgs.xkcd.com/comics/standards.png){#fig-timeseries-standards fig-align="center"}
...
::: {}
<center>
{{< video https://youtu.be/EwjvA2OcdHs width="560" height="400" align="center" title="" >}}
</center>
Introducing `tsibbles`: a data structure for Time Series data
:::
...
#| tbl-cap: "PBS Clean Dynamic Data Table"
#| code-fold: true
...
In the Tutorials linked in @sec-slides-and-tutorials, we will explore:
