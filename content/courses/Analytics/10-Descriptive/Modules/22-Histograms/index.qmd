...
`diamonds` dataset. As always, we will use `janitor` to clean up the column names:
...
cite_packages(
  ...
  pkgs = c("crosstable","ggridges", "NHANES", "TeachHist",
           "TeachingDemos", "visualize", "janitor")
) %>%
