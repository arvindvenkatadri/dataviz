...
theme_custom <- function(){ 
    ...
    theme_bw(base_size = 10) + 
        ...
        theme(plot.margin = margin_auto(t = 1, r = 2, b = 1, l = 1, 
                                        unit = "cm"),
...
##
## As of May 2026, the `available_tags()` command seems to have a bug.
# osmdata::available_tags(feature = "highway") %>% reactable::reactable(data = ., filterable = TRUE, minRows = 10)
...
```{r}
#| label:  spatial-data-from-natural-earth
india <- 
...
# Plot the cities in India alone
  ...
  tm_credits("Geographical Boundaries of India are not accurate",
             size = 0.5,
...
We could have done a (much, much!) better job, by combining cuisines into
