---
title: <iconify-icon icon="gis:proj-geo" width="1.2em" height="1.2em"></iconify-icon> Introduction to Maps
...
library(osmdata) # Import Open Street Map Data
...
Let us now understand the basics of geospatial data. Then we will understand how the R packages `sf`, `tmap` work to create maps, using data downloadable into
...
::: callout-note
### Vector Data
We will be dealing with **vector data**. This is data that is represented as points, lines and polygons. The data is stored in a format that allows us to manipulate it easily, such as ESRI Shapefiles, GeoJSON, or other formats.

There is another type of geospatial data, called **raster data**. This is data that is represented as a grid of pixels, such as satellite imagery or aerial photographs. We will not be dealing with raster data in this module.

We will deal with raster data in a future module.
