---
title: <iconify-icon icon="gis:proj-geo" width="1.2em" height="1.2em"></iconify-icon> Interactive Maps With Mapview
date: 31-July-2022
date-modified: today
...
# library(pak)
# pak::pak("datadotworld/data.world-r", build_vignettes = TRUE)
...
# Or manually run this chunk once to get the data and save it as a GeoPackage file for future us
...
sf::st_write(restaurants, dsn = "./gpkg-data/restaurants.gpkg", 
         append = FALSE, quiet = FALSE) # Save the data as a GeoPackage file for future use
```
...
restaurants <- sf::st_read("./gpkg-data/restaurants.gpkg")
