...
-   How can we ***manipulate*** these geometric aesthetics, perhaps like
    Kandinsky?
-   The aesthetic has a property, an atribute, which we can manipulate
    in accordance with a data variable!
-   [This act of "mapping" a **geometric thing** to a **variable** and
    modifying its essential property is called Data
