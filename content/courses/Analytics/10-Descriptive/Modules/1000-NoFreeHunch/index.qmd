...
## {{< iconify mdi insect size = 1.5em >}} {{< iconify game-icons pointy-hat >}} Free Hunch #9: Which college on campus has more "gender-ambivalent" people?

::: callout-important
## {{< iconify academicons hypothesis-square >}} Do "gender-ambivalent" people undertake specific courses to study?
:::

So, a survey of people from different colleges on campus. And then a prop.test to see if there are differences in proportions.
