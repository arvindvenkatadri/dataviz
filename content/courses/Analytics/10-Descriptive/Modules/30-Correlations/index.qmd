...
#| fig-subcap:
#| - Segments show deviations from means
#| - Red Areas are positive, Blue areas are negative
#| echo: false
#| warning: false
#| message: false
#| layout-ncol: 2
...
x <- rnorm(25)
y <- x + rnorm(25,3, .5)
cor.rect.plot(x,y, xlab = "Variable X", ylab = "Variable Y", main = "Positive Correlation")
