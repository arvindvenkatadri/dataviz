...
The graph in the middle @fig-contingency-expected-actual-diff-2 shows a similar but fictitious plot but with the cuts neatly horizontal or vertical. This mosaic would be what we would **expect**, if `Education` and the opinion on `Death Penalty` were independent!!
...
More when we get into [Inference for Two Proportions.](../../../20-Inference/Modules/190-TwoProp/index.qmd)
