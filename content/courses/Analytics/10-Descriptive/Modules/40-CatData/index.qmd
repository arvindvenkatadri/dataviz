...
HairEyeColor %>% 
  as_tibble() %>%  # Convert
  knitr::kable(theme = "striped", caption = "Hair Eye and Color<br> as a Data Frame",
centering = TRUE)
...
vcd::structable(Education ~ 0, data = GSS2002) %>% vcd::mosaic(
  gp = shading_Friendly,
  main = "GSS2002 Education Mosaic Chart Step#1")

vcd::structable(DeathPenalty ~ Education, data = GSS2002) %>% 
vcd::mosaic(
  gp = shading_hsv, direction = "v",
  main = "GSS2002 Education Mosaic Chart Step#2")
...
vcd::mosaic(Improved ~ Treatment, data = Arthritis, type = "expected", direction = "v", gp = shading_max)
vcd::assoc(Treatment ~ Improved, data = Arthritis, gp = shading_max) # Note formula direction!
