...
```{r}
#| label: fig-vcd-case-form-ct
#| fig-cap: Creating Contingency Tables from Case Form Data with `vcd`
#| layout-ncol: 2
#| output: true
...
```{r}
#| label: fig-base-case-form-ct
#| fig-cap: Creating Contingency Tables from Case Form Data with `base::ftable()`
#| layout-ncol: 2
Arthritis %>% class()
...
```{r}
#| label: fig-vcd-freq-form-ct
#| fig-cap: Creating Contingency Tables from Frequency Form Data with `vcd`
#| layout-ncol: 2
...
```{r}
#| label: fig-vcd-multitable-data-ct
#| fig-cap: Creating Contingency Tables from Table Form Data with `vcd`
#| layout-ncol: 2
...
```{r}
#| label: fig-base-multitable-data-ct
#| fig-cap: Creating Contingency Tables from Table Form Data with `base::ftable()`
#| layout-ncol: 2
...
```{r}
#| label: fig-gss2002-data
#| fig-cap: GSS 2002 Data
#| echo: false
#| warning: false
...
```{r}
#| label: fig-gss2002-ct
#| fig-cap: GSS 2002 Contingency Table
#| echo: false
#| warning: false
...
The answer is provided in *the very shape of the CT*: we plot this as
...
bottom ROW of the @fig-gss2002-ct. HS is clearly
...
```
The `visStatistics` package is a very powerful package that can be used to create a wide variety of statistical charts, including Mosaic Charts, with very little code. This "universal" command `visstat()` computes a good many statistics and plots, all in one. Try doing an `str()` after this command to see what (else) it has computed. 
