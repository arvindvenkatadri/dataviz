...
1. MacOS: In a terminal type: `xcode-select --install`. This will also install `git`.
...
![RStudio Project Options Window](../../../../../materials/images/windows-rstudio-git-executable-screenshot.png){#fig-RStudio-Git-Executable fig-align="center" width="60%"}
...
As far as I know, this process, though simple, can only be used at start up time. Can't use this every time you have new content. For that, use the Git pane in RStudio, or a GUI git client such as [Gitkraken](https://www.gitkraken.com) (recommended).
:::
