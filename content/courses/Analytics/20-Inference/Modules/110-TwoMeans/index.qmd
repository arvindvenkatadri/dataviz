...
#| fig-caption: AMAS Anxiety Score graphs
#| fig-subcap:
...
yrbss_select_phy %>% 
  gf_jitter(weight ~ physical_3plus, colour = ~ physical_3plus,
   ...
   gf_summary(
    ...
    gf_summary(fun = "mean", geom = "point", size = 3, colour = "firebrick") %>%
  gf_refine(scale_x_discrete(
    breaks = c("no", "yes"),
    labels = c("no", "yes"),
    guide = "prism_bracket"
  ...
  gf_refine(
    ...
    annotate(x = 1.5, y = 100, geom = "label", label = "Slope indicates\n differences in mean", fill = "moccasin"),
    scale_colour_brewer(name = "Days of Exercise >=3", palette = "Set2"))
...
gf_density(~ weight,
  ...
  gf_refine(scale_fill_brewer(name = "Days of Exercise >=3", palette = "Set2"))
