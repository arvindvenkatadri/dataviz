...
```
In @fig-confidence-intervals-examples, we see that $95\%$ confidence intervals straddle the population mean shown in black, almost always. One sample in 50 has missed it and is shown in pink. For a particular sample with $\bar{x} = 100$, the vertical red lines show the confidence interval derived from *that* sample. 
...
gf_refine(scale_y_continuous(expand = c(0,0.02))) %>%
...
gf_annotate("curve", 
            ...
            xend = mean_sample_16  + 0.5, yend = 0.125,
            curvature = -0.25, color = "purple", 
            arrow = arrow(length = unit(0.25,"cm"))) %>% 
gf_annotate("curve", 
            x = pop_mean - 4, y = 0.14, 
            xend = pop_mean - 0.5, yend = 0.125,
