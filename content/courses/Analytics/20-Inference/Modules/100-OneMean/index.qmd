...
cite_packages(
  ...
  out.dir = ".",
  out.format = "html",
  pkgs = c("ellmer", "explore", "resampledata", "openintro", "infer", "statlingua", "TeachHist", "TeachingDemos")
) %>%
...
The command was run in the Console and the results pasted into this Quarto document. I have not edited this at all. Do look for complex verbiage and outright hallucinatory responses. The very last para seems to be...hmmm!!
