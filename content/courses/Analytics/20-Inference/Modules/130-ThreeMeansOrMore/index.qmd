...
ggplot2::update_geom_defaults(geom = GeomMarquee, new = list(
  family = "Roboto Condensed",
  face = "plain",
  size = 3.5,
  color = "#2b2b2b"
...
frogs_long %>% 
  ...
  gf_annotate("label", label = TeX(r"($Time = 26.3 - 5.3 \times TempFac18  -10.1 \times TempFac25 + e)"), y = 26.3,  x = 2.25, 
...
2. Can you try to ANOVA-analyse the datasets we dealt with in plotting [Groups with Boxplots](../../../10-Descriptive/Modules/24-BoxPlots/index.qmd#your-turn)?
