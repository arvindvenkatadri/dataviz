...
p2 <- gf_boxplot(data = gss_wages, realrinc ~ gender, 
              ...
              alpha = 0.8, orientation = "x") %>% 
  gf_labs(y = "Income", x = "Gender", 
          title = "GSS-Wages Dataset") %>% 
...
There are several variables, most of them "man-made", which tend to vary over several orders of magnitude. Let us see how we can depict those. 
...
cite_packages(
  ...
  out.dir = ".",
  out.format = "html",
  pkgs = c("gghighlight", "scales", "ggtext", "ggfocus")
) %>%
