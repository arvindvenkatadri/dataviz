...
patchwork::wrap_plots(p10,p20, ncol = 2) + plot_annotation(tag_levels = "1", tag_prefix = "P")
...
cite_packages(
  ...
  out.dir = ".",
  out.format = "html",
  pkgs = c("paletteer", "RColorBrewer", "ggthemes", "patchwork", "grDevices", "reactable", "wesanderson", "gameofthrones", "harrypotter")) %>%
