...
gf_point(body_mass ~ flipper_len, 
           ...
           gf_labs(title = "Default QUAL Colours in ggplot",
...
penguins %>% 
  ...
  gf_point(body_mass ~ flipper_len, 
      ...
      gf_labs(title = "Default QUANT Colours in ggplot",
              x = "Flipper Length (mm)", y = "Body Mass (g)") # Add labels
...
## Changing Colour Scales ~~with chameleon ease~~
...
```{r}
#| label:  Applying_RColorBrewer_palettes
#| results: hold
...
p11 <- p1 +
  ...
  labs(title = "RColorBrewer QUAL Palette = Set2",
       subtitle = "Discrete Qualitative Variable") 

p21 <- p2 +
  scale_color_distiller(palette = "YlOrRd") +
  labs(title = "RColorBrewer QUANT Palette = YlOrRd",
       subtitle = "Continuous Quantitative Variable") 

patchwork::wrap_plots(p11,p21, ncol = 2)
...
p12 <- p1 +
  scale_colour_paletteer_d("ggthemes_ptol::qualitative", 
                           dynamic = TRUE) +
  labs(title = "QUAL Palettes from `paletteer`", 
...
patchwork::wrap_plots(p12,p22, ncol = 2)
...
```{r}
#| label: continuous_palettes
p22 <- p2 + 
  scale_color_got("gameofthrones::jon_snow") +
  labs(title = "Using QUANT palette\n from `GameofThrones`",
...
patchwork::wrap_plots(p22,p23, ncol = 2)
...
cite_packages(
  ...
  out.dir = ".",
  out.format = "html",
  pkgs = c("paletteer", "RColorBrewer", "wesanderson", "gameofthrones", "scales", "ggthemes", "systemfonts", "showtext", "colorspace", "patchwork")
) %>%
