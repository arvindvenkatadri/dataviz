...
![Least
Squares](../../../../../materials/images/OLS.png){#fig-least-squares
height="360"}
...
![OLS
Assumptions](../../../../../materials/images/ols_assumptions.png){#fig-ols-assumptions}
...
Correlations](../../../10-Descriptive/Modules/30-Correlations/#the-errorbar-plot-for-correlations),
...
#| fig-cap: "Linear Model: Price vs Average no. of Rooms: Residuals for NULL and Alternate Hypotheses"
#| fig-subcap:
#| - "NULL Hypothesis: No relationship between Price and Rooms"
#| - "Alternate Hypothesis: Linear relationship between Price and Rooms"
#| code-fold: true
#| layout-ncol: 2
#| warning: false
#| 
...
of these residuals in @fig-housing-lm-intuitive2-1 is called the
[**Total Sum of Squares** (SST)]{style="background-color: yellow;"}.
...
.black} are the residuals of each point from the potential line of fit.
The sum of the *squares* of these lines is called the [**Total Error Sum
of Squares** (SSE)]{style="background-color: yellow;"}.
