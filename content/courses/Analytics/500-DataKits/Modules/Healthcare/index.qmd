...
#
library(NHANES)
# library(DataSetsVerse) # Choose MedDataSets
...
Team#4: Meghana / Shreeya / Shivgun  | {{< downloadthis "health-kits/group-4-youth-risk.zip" dname="DataKit4" label="Download DataKit #4" icon="database-fill-down" type="info" >}}
 | 
Team#5: Anmol / Debu / Ishita / Jai | {{< downloadthis "health-kits/group-5-failure-and-asia.zip" dname="DataKit5" label="Download DataKit #5" icon="database-fill-down" type="info" >}}
 | 
Team#6: Kasyap / Jayani / Rachana / Madhumitha  | {{< downloadthis "health-kits/group-6-acs-and-africa.zip" dname="DataKit6" label="Download DataKit #6" icon="database-fill-down" type="info" >}}
 | 
~~Team#7: Anushka / Madhumitha / Jai Aditya~~ | ~~{{< downloadthis "health-kits/group-7-ercp-and-americas.zip" dname="DataKit7" label="Download DataKit #7" icon="database-fill-down" type="info" >}}~~
