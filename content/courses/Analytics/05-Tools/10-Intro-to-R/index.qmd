...
![Playing Croquet](../../../../materials/images/1book31.jpg){height=300 fig-align="center"}
...
#| out-height: "50%"
#| out-width: "50%"
#| fig-cap: "RStudio Default Window"

knitr::include_graphics("../../../../materials/images/rstudio-panes-labeled.jpeg")
...
-   provide a visualization, provide insight, tell a story
-   is [reproducible]{.bg-yellow .black} 
-   be a call to action or a recommendation towards a decision
...
#| out-height: "50%"
#| out-width: "50%"
#| fig-cap: "Quarto Check"

knitr::include_graphics("../../../../materials/images/quarto-check.png")
...
```{r}
#| label: fig-visual-source
#| echo: false
#| fig-align: center
#| out-height: "100%"
#| out-width: "100%"
#| fig-cap: "Switching to Visual Mode"

knitr::include_graphics("../../../../materials/images/visual-toolbar.png")
...
```{r}
#| label:  fig-plot-name-data
#| fig-cap: "My Name over the Years"
#| out-width: "75%"
#| fig-align: "center"
#| echo: fenced

# Save our Chart as "my_plot"
my_plot <- gf_line(prop ~ year, 
        color = ~ name, 
        data = my_name_data)
...
Now if you did this right, you will **see** your plot! And get a nice caption and figure number below! 
...
15. Share your Plot separately if you want: You will not like the looks of your plot if you mouse over to `Export` and save it. And you may need to paste it into Word documents for instance. 

Instead, use `ggplot2`'s `ggsave` command for saving a plot with sensible defaults. Type `help(ggsave)` in your Console to learn more about this useful command. And here is your final code chunk:

```{{r}}
#| label: saving-my-plot

# Saving "my_plot" to a PDF 
# please make the filename unique!
ggsave("path/to/my/file_name_here.pdf", my_plot) 
...
1. Quarto: The Definitive Guide. <https://quarto-tdg.org/>
...
1.  <https://quarto.org/docs/authoring/markdown-basics.html> How to do more with Quarto HTML format.
1. <https://apps.machlis.com/shiny/quartotips/>

::: {}
<center>
{{< video https://youtu.be/_f3latmOhew  width="560" height="400" align="center" title="" >}}
</center>
